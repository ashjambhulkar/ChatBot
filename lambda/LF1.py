...
API_KEY='5SzEAKiD8ZnWoWKRihJy4cQicMDlTQx4aVUeWo_jXA9Pw4bkQvXFbyQtYz6Xqo-n3v2enO5FT1Tl8wrmGfKw8kiXgR0PoJENhxWF8YSUk8kcWmM0c9PeFBsc2keEXHYx'
...
def restaurantApiCall(requestData):
    ...
    payload = ""
    headers={'Authorization': 'Bearer 5SzEAKiD8ZnWoWKRihJy4cQicMDlTQx4aVUeWo_jXA9Pw4bkQvXFbyQtYz6Xqo-n3v2enO5FT1Tl8wrmGfKw8kiXgR0PoJENhxWF8YSUk8kcWmM0c9PeFBsc2keEXHYx'}
    ...
    textString = "Hey! Here are our " + requestData['categories'] + " restaurant suggestions for " + requestData['peoplenum'] +" people, for " + requestData['Date'] + " at " + requestData['Time'] + ". "
    count = 1
